...
public class SpecReader {
    ...
    /**
     * Get the Ballerina string representation of the input field type from the `GraphQLInputObjectField` instance.
     *
    ...
    /**
     * Get the Ballerina string representation of the input field type from the `GraphQLFieldDefinition` instance.
     *
